...
var AppComponent = (function () {
    function AppComponent() {
        ...
        __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].interval(1000).subscribe(function () {
            _this.toWords();
        });
    }
    AppComponent.prototype.toWords = function () {
        this.now = __WEBPACK_IMPORTED_MODULE_2_moment__().format('LT');
